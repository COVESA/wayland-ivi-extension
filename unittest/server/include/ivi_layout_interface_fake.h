...
// DECLARE_FAKE_VALUE_FUNC(struct ivisurface *, get_surface, struct wl_list *, struct ivi_layout_surface *);
...
DECLARE_FAKE_VALUE_FUNC(int32_t, shell_add_destroy_listener_once, struct wl_listener *, wl_notify_func_t);
...
#define IVI_LAYOUT_FAKE_LIST(FAKE) \
    ...
    FAKE(shell_add_destroy_listener_once)
